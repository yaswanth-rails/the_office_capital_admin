...
module RailsAdmin
  ...
  config.actions do
    ...
    index                         # mandatory
    new do
      except  ['Company','Invoice','JobAnswer','ContactSubmission','Booking','BookingGroup','ExternalGuest','Group','HotDedicatedDeskLog','JobApplication','JobApplicant','Wallet','WalletHistory','Deposit','UserCouponUse','Withdraw','Review','PaperTrail::Version','PaperTrail::Association']
    end
    ...
    show
    edit do
      except ['Group','Invoice','JobAnswer','ContactSubmission','HotDedicatedDeskLog','UserCouponUse','WalletHistory','EmployeeKycStat','Deposit','ExternalGuest','LoginHistory','Review','PaperTrail::Version','PaperTrail::Association']
    end
    # delete do
